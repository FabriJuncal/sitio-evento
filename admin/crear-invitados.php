                    ...
                    <form class="form-horizontal needs-validation" name="guardar-registro" id="guardar-registro-archivo" method="post" action="modelo-invitado.php" enctype="multipart/form-data">
                      <div class="card-body">
                           <div class="form-group row">
                              ...
                              <div class="col-sm-10">
                                <input type="text" class="form-control" id="nombre_invitado" name="nombre_invitado" placeholder="Nombre Invitado" required>
                              </div>
                            </div>
                            <div class="form-group row">
                              <label for="apellido_invitado" class="col-sm-2 col-form-label">Apellido:</label>
                              <div class="col-sm-10">
                                <input type="text" class="form-control" id="apellido_invitado" name="apellido_invitado" placeholder="Apellido Invitado" required>
                              </div>
                            </div>
                            <div class="form-group row">
                              ...
                              <div class="input-group col-sm-10">
                                <div class="custom-file">
                                  ...
                                  <!-- Para cambiar el Icono pegado al Input ir:
                                      ...
                                      Propiedad: "content"
                                   -->
                                  <label class="custom-file-label" for="imagen_invitado">Seleccione una Imagen</label>
                              </div>
                            </div>
                        </div>
                      </div>
